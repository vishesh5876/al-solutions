...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "AL Solutions — Digital Agency" },
      {
        name: "description",
        content:
          "AL Solutions is a digital agency building websites, apps, software and growth for ambitious brands.",
      },
      { name: "author", content: "AL Solutions" },
